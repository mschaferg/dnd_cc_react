...
const Characteristics = ({ handleChange2, handleChange3 }) => {
    ...
    return (
        <div class="child1">
            ...
            <form onChange={handleChange3}>
                <h3><u>Subrace</u></h3>
                <label for="subrace">Choose your subrace:</label>
                <select class="select" name="subrace" id="subrace">
            ...
            <h3><u>Class</u></h3>
            <label for="job">Choose your class:</label>
            ...
            <select class="select" name="background" id="background">
